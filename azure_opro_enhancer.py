...
from yival.experiment.utils import generate_experiment, get_selection_strategy
...
from yival.enhancers.utils import (
...
def fetch_next_variations(prompt: str) -> str:
    """
...
class OptimizeByPromptEnhancer(BaseCombinationEnhancer):
    ...
    def fetch_next_variations(self, prompt: str) -> str:
        """
        enhance prompt according to opro enhancer
        fetch the next variations from llm output
        """
